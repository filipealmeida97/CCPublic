...
<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=PT+Serif:wght@400;700&display=swap" rel="stylesheet">
    <style>
    h1,h2,h3 {        
...
<body>
    ...
    <div class="content">
        ...
        <p>Este Contrato tem como objetivo a cessão, em regime de comodato, por parte da <strong>COMODANTE</strong> ao(a) <strong>COMODATÁRIO(A)</strong>, do CELULAR '.$_POST['marcmodel'].' e seus acessórios (“Celular”), descrito abaixo, cuja entrega ocorre no ato de assinatura deste Contrato.</p>
        <ul class="especs">
          <li><p><strong>Modelo: </strong>'.$_POST['modelo'].'</p></li>
          <li><p><strong>S/N: </strong>'.$_POST['serie'].'</p></li>
          <li><p><strong>IMEI: </strong>'.$_POST['imei'].'</p></li>
          <li><p><strong>N° PATRIMÓNIO: </strong>'.$_POST['pat'].'</p></li>
          <li><p><strong>Nº CELULAR: </strong>'.$_POST['tel'].'</p></li>
          <li><p><strong>PLANO DE DADOS: </strong>'.$_POST['pDados'].'</p></li>
          <li><p><strong>PACOTE VOZ: </strong>'.$_POST['pVoz'].'</p></li>
        </ul>
        ...
        <ol class="clas-terceira">
          <li><p>Devolver o Celular e carregador nas mesmas condições em que os recebeu, ressalvado o desgaste natural, decorrente do uso normal e regular;</p></li>
          <li><p>Zelar pela integridade do Celular e seus acessórios, identificados na cláusula primeira deste contrato, mantendo-os sob sua responsabilidade, e em perfeitas condições de funcionamento;</p></li>
          <li><p>Arcar com as despesas necessárias ao reparo do Celular e/ou de seu carregador, bem como eventuais reposições no caso de ocorrência de danos, provenientes do mau uso do Celular, e/ou de seu carregador, pelo (a) <strong>COMODATÁRIO (A)</strong>;</p></li>
          <li><p>Informar, imediatamente, à <strong>COMODANTE</strong> os casos de defeitos do Celular e/ou carregador, para que esta adote as medidas pertinentes;</p></li>
          <li><p>Comunicar, imediatamente, à <strong>COMODANTE</strong> os casos de extravio, furto ou roubo do Celular e/ou carregador, além de apresentar Boletim de Ocorrência Policial, no prazo de 24 (vinte e quatro) horas, para que a <strong>COMODANTE</strong> acione o seguro do equipamento;</p></li>
          <li><p>Devolver o Celular e seu carregador cedidos em comodato durante os períodos de férias e licenças, iguais ou superiores a 20 (vinte) dias, diretamente no setor de TI da <strong>COMODANTE</strong>;</p></li>
        </ol>
        <h3><strong><u>CLÁUSULA QUARTA  -  OBRIGAÇÕES DA COMODANTE</u></strong></h3>
        <p>Entregar ao(à) <strong>COMODATÁRIO(A)</strong> o Celular, assim como o(s) acessório(s), em perfeito estado de uso e funcionamento.</p>
        <h3><b><u>CLÁUSULA QUINTA – DO RESSARCIMENTO EM CASO DE PERDA OU EXTRAVIO</u></b></h3>
        <p>O <strong>COMODATÁRIO(A)</strong> reconhece que a perda ou extravio do Celular e seu carregador ensejará o ressarcimento à <strong>COMODANTE</strong>, de 100% do preço de compra do equipamento.</p>
        <div class="c-sexta">
            <h3><strong><u>CLÁUSULA SEXTA  -  RESCISÃO</u></strong></h3>
            <p>A inobservância ou inadimplemento de qualquer das cláusulas ou condições deste Contrato, por parte do(a) <strong>COMODATÁRIO(A)</strong>, implicará em sua imediata rescisão, com a consequente devolução do Celular, objeto do presente, sem prejuízo da cobrança de eventuais perdas e danos, por parte da <strong>COMODANTE</strong>.</p>
        </div>
        ...
        <p>O (A) <strong>COMODATÁRIO (A)</strong> tem conhecimento que o Celular ora cedido é para uso exclusivo no exercício de suas funções, concordando que todas as despesas relativas aos danos causados ao equipamento, decorrentes da má utilização, poderão ser cobradas em sua integralidade.</p>
        <p>O (A) <strong>COMODATÁRIO (A)</strong> só deverá transportar o Celular, para ambiente externo à Leve, quando demandado pelo seu gestor imediato, mediante solicitação expressa;</p>
        <p>Nas ocasiões em que o (a) <strong>COMODATÁRIO (A)</strong> desejar transportar o Celular, para ambiente externo à Leve, sem demanda para a Leve, assume total responsabilidade sobre o bem comodatado.</p>
        <p><u>Parágrafo Único</u> – O Celular será de uso exclusivo do (a) COMODATÁRIO (A), não devendo ceder a qualquer outra pessoa, ainda que familiar.</p>
...
$dompdf->stream('Contrato de Comodato Leve Saúde Operadora CELULAR - '.$_POST['nome'].' '.$_POST['sobrenome'].'.pdf', [
    'compress' => true,
    'Attachment' => false,
]);