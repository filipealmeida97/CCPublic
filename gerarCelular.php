...
<body>
    ...
    <div class="content">
        ...
        <p>O (A) <strong>COMODATÁRIO (A)</strong> só deverá transportar o Celular, para ambiente externo à LOREM, quando demandado pelo seu gestor imediato, mediante solicitação expressa;</p>
        <p>Nas ocasiões em que o (a) <strong>COMODATÁRIO (A)</strong> desejar transportar o Celular, para ambiente externo à LOREM, sem demanda para a LOREM, assume total responsabilidade sobre o bem comodatado.</p>
...
$dompdf->stream('Contrato de Comodato CELULAR - '.$_POST['nome'].' '.$_POST['sobrenome'].'.pdf', [
    'compress' => true,
    'Attachment' => false,
]);